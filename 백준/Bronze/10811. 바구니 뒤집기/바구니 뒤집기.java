...
//
//		1-1) 둘째 줄부터 M개의 줄에는 바구니의 순서를 역순으로 만드는 방법이 주어진다. 
...
//		모든 순서를 바꾼 다음에, 가장 왼쪽에 있는 바구니부터 바구니에 적혀있는 순서를 공백으로 구분해 출력한다.
		...
		int N = Integer.parseInt(st.nextToken()); // 정수형으로 형변환 후 N에 저장
		int M = Integer.parseInt(st.nextToken()); // 정수형으로 형변환 후 M에 저장
